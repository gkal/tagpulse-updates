...
Wed 02-09-2026 16:46 - v0.6.230b (stable) fixes on security and async to be better reactions

Tue 01-09-2026 17:10 - v0.6.229b (stable) various fixes
...
Sun 05-07-2026 14:11 - v0.6.186 (stable) Setup Build
...
Fri 03-07-2026 06:19 - v0.6.183 (stable) Setup Build

Thu 02-07-2026 18:22 - v0.6.182b (stable) che split complete

Thu 02-07-2026 13:47 - v0.6.181b (stable) che fixes

Mon 22-06-2026 15:28 - v0.6.180 (stable) fixes

Mon 22-06-2026 14:54 - v0.6.180 (stable) Setup Build

Mon 22-06-2026 13:15 - v0.6.179b (stable) improvments on watchdog and on installation

Sun 21-06-2026 16:09 - v0.6.178 (stable) last fixes

Sun 21-06-2026 15:27 - v0.6.177 (stable) Setup Build

Sun 21-06-2026 13:58 - v0.6.176b (stable) -all software update improvments

Sun 21-06-2026 10:56 - v0.6.175b (stable) -all software update improvments
...
Fri 19-06-2026 10:59 - v0.6.171b (stable) big fixes and new che

Fri 19-06-2026 09:34 - v0.6.170b (stable) big fixes and new che

Thu 11-06-2026 17:25 - v0.6.169 (stable) new fixes

Thu 11-06-2026 17:15 - v0.6.168 (stable) Setup Build
...
Sat 02-05-2026 09:05 - v0.6.154 (stable) fixing logs problem
...
Fri 23-01-2026 19:04 - v0.6.80b (stable) Pulsie introduction and many fixes v3
...
Tue 20-01-2026 19:29 - v0.6.76 (stable) fixed error 4xx and 5xx

Tue 20-01-2026 14:50 - v0.6.75 (stable) updater fixes,fan fixes, timeout fixes

Tue 20-01-2026 14:29 - v0.6.74b (stable) updater fixes,fan fixes, timeout fixes

Sat 17-01-2026 13:52 - v0.6.73 (stable) Fan degradation fixes
...
Sun 04-01-2026 20:26 - v0.6.58 (stable) updater fixes

Sun 04-01-2026 19:01 - v0.6.57 (stable) Slowe internet fixes

Sun 04-01-2026 18:02 - v0.6.56 (stable) updater fixes

Sun 04-01-2026 10:35 - v0.6.55 (stable) minor fixes at the logs

Sun 04-01-2026 09:38 - v0.6.54 (stable) Cancel commands added
...
Tue 25-11-2025 15:23 - v0.5.110b (stable) CHE baseline fix
...
Sun 23-11-2025 08:46 - v0.5.93b (stable) update fixes

Sun 23-11-2025 08:00 - v0.5.92b (stable) software impact improvments complete

Sun 23-11-2025 07:43 - v0.5.91b (stable) software impact improvments
...
Mon 17-11-2025 14:29 - v0.5.67 (stable) Setup build with the same version as the last deploy
Mon 17-11-2025 13:42 - v0.5.67 (stable) fix beta stable difference

Mon 17-11-2025 13:06 - v0.5.66b (stable) history fixes updater fixes,cleanup 30d on the supa records

Mon 17-11-2025 12:55 - v0.5.65 (stable) Setup build with the same version as the last deploy
...
Sun 16-11-2025 12:21 - v0.5.61b (stable) beta tester:update check

Sun 16-11-2025 10:36 - v0.5.60b (stable) beta tester:update check
...
Sun 16-11-2025 09:25 - v0.5.55b (beta) fix corrupted manifest from previous failed update
...
Sun 16-11-2025 08:36 - v0.5.52b (beta) test clean beta implementation
...
Fri 07-11-2025 06:03 - v0.5.35 (stable) Setup build with the same version as the last deploy
...
Thu 06-11-2025 19:07 - v0.5.32 (stable) Fixes on setup and on updater and on tagpulse

Thu 06-11-2025 14:39 - v0.5.31 (stable) Setup build with the same version as the last deploy
Thu 06-11-2025 14:36 - v0.5.31 (stable) Setup build with the same version as the last deploy
